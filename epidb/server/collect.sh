#echo ggm
pg_dump -t epidb_results_intake -t epidb_results_weekly ggm --clean > /home/epidb/data/epidb_results.sql 2>/dev/null > /dev/null
...
#echo flusurvey
pg_dump --data-only -t epidb_results_intake -t epidb_results_weekly flusurvey >> /home/epidb/data/epidb_results.sql 2>/dev/null > /dev/null

#echo gripenet
pg_dump --data-only -t epidb_results_intake -t epidb_results_weekly gripenet >> /home/epidb/data/epidb_results.sql 2>/dev/null > /dev/null
...
#echo influweb
pg_dump --data-only -t epidb_results_intake -t epidb_results_weekly influweb >> /home/epidb/data/epidb_results.sql 2>/dev/null > /dev/null
