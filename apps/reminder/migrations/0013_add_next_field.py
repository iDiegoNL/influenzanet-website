...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsLetter.next'
        db.add_column('reminder_newsletter', 'next', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NewsLetter.next'
        db.delete_column('reminder_newsletter', 'next')
