...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReminderSettings.send_resubscribe_email'
        db.add_column('reminder_remindersettings', 'send_resubscribe_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ReminderSettings.resubscribe_email_subject'
        db.add_column('reminder_remindersettings', 'resubscribe_email_subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ReminderSettings.resubscribe_email_message'
        db.add_column('reminder_remindersettings', 'resubscribe_email_message',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReminderSettings.send_resubscribe_email'
        db.delete_column('reminder_remindersettings', 'send_resubscribe_email')

        # Deleting field 'ReminderSettings.resubscribe_email_subject'
        db.delete_column('reminder_remindersettings', 'resubscribe_email_subject')

        # Deleting field 'ReminderSettings.resubscribe_email_message'
        db.delete_column('reminder_remindersettings', 'resubscribe_email_message')
    ...
    models = {
        ...
        'reminder.remindersettings': {
            ...
            'resubscribe_email_message': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'resubscribe_email_subject': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'send_reminders': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'send_resubscribe_email': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
