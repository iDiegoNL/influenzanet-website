...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsLetter.userlist'
        db.add_column('reminder_newsletter', 'userlist', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NewsLetter.userlist'
        db.delete_column('reminder_newsletter', 'userlist')
