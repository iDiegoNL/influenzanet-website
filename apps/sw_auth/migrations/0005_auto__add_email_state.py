...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EpiworkUser.email_state'
        db.add_column('sw_auth_epiworkuser', 'email_state', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EpiworkUser.email_state'
        db.delete_column('sw_auth_epiworkuser', 'email_state')
