...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'UserBadge', fields ['badge', 'participant', 'user']
        db.create_unique('dashboard_userbadge', ['badge_id', 'participant_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'UserBadge', fields ['badge', 'participant', 'user']
        db.delete_unique('dashboard_userbadge', ['badge_id', 'participant_id', 'user_id'])
    ...
    models = {
        ...
        'survey.surveyuser': {
            ...
            'global_id': ('django.db.models.fields.CharField', [], {'default': "'0b628d6c-67f4-4aaa-9ae5-890479a00076'", 'unique': 'True', 'max_length': '36'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
