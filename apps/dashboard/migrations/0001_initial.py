...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Badge'
        db.create_table('dashboard_badge', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('label', self.gf('django.db.models.fields.TextField')()),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('datasource', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('attribute_to', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('season', self.gf('django.db.models.fields.IntegerField')(default=None, null=True)),
        ))
        db.send_create_signal('dashboard', ['Badge'])

        # Adding model 'UserBadge'
        db.create_table('dashboard_userbadge', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.SurveyUser'], null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('badge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Badge'])),
        ))
        db.send_create_signal('dashboard', ['UserBadge'])


    def backwards(self, orm):
        
        # Deleting model 'Badge'
        db.delete_table('dashboard_badge')

        # Deleting model 'UserBadge'
        db.delete_table('dashboard_userbadge')
    ...
    models = {
        ...
        'survey.surveyuser': {
            ...
            'global_id': ('django.db.models.fields.CharField', [], {'default': "'7170c56c-bf73-4ab2-bd00-0469e9f91594'", 'unique': 'True', 'max_length': '36'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
