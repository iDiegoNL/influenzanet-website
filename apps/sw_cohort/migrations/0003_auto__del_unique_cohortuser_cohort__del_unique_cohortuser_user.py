...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'CohortUser', fields ['user']
        db.delete_unique('sw_cohort_cohortuser', ['user_id'])

        # Removing unique constraint on 'CohortUser', fields ['cohort']
        db.delete_unique('sw_cohort_cohortuser', ['cohort_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'CohortUser', fields ['cohort']
        db.create_unique('sw_cohort_cohortuser', ['cohort_id'])

        # Adding unique constraint on 'CohortUser', fields ['user']
        db.create_unique('sw_cohort_cohortuser', ['user_id'])
    ...
    models = {
        ...
        'survey.surveyuser': {
            ...
            'global_id': ('django.db.models.fields.CharField', [], {'default': "'7c36d2c7-2336-4862-ac76-33bede5d8d0d'", 'unique': 'True', 'max_length': '36'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
