...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PregnantCohort.date_reminder'
        db.add_column('grippenet_pregnantcohort', 'date_reminder', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'PregnantCohort.reminder_count'
        db.add_column('grippenet_pregnantcohort', 'reminder_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PregnantCohort.date_reminder'
        db.delete_column('grippenet_pregnantcohort', 'date_reminder')

        # Deleting field 'PregnantCohort.reminder_count'
        db.delete_column('grippenet_pregnantcohort', 'reminder_count')
    ...
    models = {
        ...
        'survey.surveyuser': {
            ...
            'global_id': ('django.db.models.fields.CharField', [], {'default': "'163b6ddb-07b1-44fe-8d81-93c96190efd7'", 'unique': 'True', 'max_length': '36'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
