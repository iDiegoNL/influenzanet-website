...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PregnantCohort.change_channel'
        db.add_column('grippenet_pregnantcohort', 'change_channel', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PregnantCohort.change_channel'
        db.delete_column('grippenet_pregnantcohort', 'change_channel')
    ...
    models = {
        ...
        'survey.surveyuser': {
            ...
            'global_id': ('django.db.models.fields.CharField', [], {'default': "'3e9b4b91-ef9b-486a-925b-c4b1de835ebe'", 'unique': 'True', 'max_length': '36'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
