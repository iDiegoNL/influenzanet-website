...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PregnantCohort'
        db.create_table('grippenet_pregnantcohort', (
        ...
        db.send_create_signal('grippenet', ['PregnantCohort'])


    def backwards(self, orm):
        
        # Deleting model 'PregnantCohort'
        db.delete_table('grippenet_pregnantcohort')
    ...
    models = {
        ...
        'survey.surveyuser': {
            ...
            'global_id': ('django.db.models.fields.CharField', [], {'default': "'45de962e-c22a-47fb-a81a-28844a8e8def'", 'unique': 'True', 'max_length': '36'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
