...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PregnantCohort.date_created'
        db.alter_column('grippenet_pregnantcohort', 'date_created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'PregnantCohort.date_created'
        db.alter_column('grippenet_pregnantcohort', 'date_created', self.gf('django.db.models.fields.DateField')(auto_now=True))
    ...
    models = {
        ...
        'survey.surveyuser': {
            ...
            'global_id': ('django.db.models.fields.CharField', [], {'default': "'c68d40cf-f86b-4d17-abdc-e1b86df1672f'", 'unique': 'True', 'max_length': '36'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
