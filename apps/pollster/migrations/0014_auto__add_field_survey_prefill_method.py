...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Survey.prefill_method'
        db.add_column('pollster_survey', 'prefill_method', self.gf('django.db.models.fields.CharField')(default='LAST', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Survey.prefill_method'
        db.delete_column('pollster_survey', 'prefill_method')
