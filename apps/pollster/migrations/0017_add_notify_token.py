...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NotifyToken'
        db.create_table('pollster_notifytoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('atoken', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('itoken', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('pollster', ['NotifyToken'])


    def backwards(self, orm):
        # Deleting model 'NotifyToken'
        db.delete_table('pollster_notifytoken')
