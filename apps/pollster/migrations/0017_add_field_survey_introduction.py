...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Survey.introduction'
        db.add_column('pollster_survey', 'introduction', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):

                # Deleting field 'Survey.introduction'
        db.delete_column('pollster_survey', 'introduction')
