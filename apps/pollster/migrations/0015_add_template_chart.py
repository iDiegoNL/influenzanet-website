...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chart.template'
        db.add_column('pollster_chart', 'template',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'SurveyChartPlugin.show_on_success'
        db.add_column('cmsplugin_surveychartplugin', 'show_on_success',
	...
	if not db.dry_run:
        ...
        # Deleting field 'SurveyChartPlugin.show_on_success'
        db.delete_column('cmsplugin_surveychartplugin', 'show_on_success')
