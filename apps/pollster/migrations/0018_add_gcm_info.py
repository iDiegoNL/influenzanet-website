...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotifyToken.updated'
        db.add_column('pollster_notifytoken', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 11, 0, 0)),
                      keep_default=False)

        # Adding field 'NotifyToken.is_gcm_invalid'
        db.add_column('pollster_notifytoken', 'is_gcm_invalid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'NotifyToken.last_gcm_message_id'
        db.add_column('pollster_notifytoken', 'last_gcm_message_id',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'NotifyToken.last_gcm_failure'
        db.add_column('pollster_notifytoken', 'last_gcm_failure',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotifyToken.updated'
        db.delete_column('pollster_notifytoken', 'updated')

        # Deleting field 'NotifyToken.is_gcm_invalid'
        db.delete_column('pollster_notifytoken', 'is_gcm_invalid')

        # Deleting field 'NotifyToken.last_gcm_message_id'
        db.delete_column('pollster_notifytoken', 'last_gcm_message_id')

        # Deleting field 'NotifyToken.last_gcm_failure'
        db.delete_column('pollster_notifytoken', 'last_gcm_failure')
