...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotifyToken.last_gcm_message_timestamp'
        db.add_column('pollster_notifytoken', 'last_gcm_message_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotifyToken.last_gcm_message_timestamp'
        db.delete_column('pollster_notifytoken', 'last_gcm_message_timestamp')
