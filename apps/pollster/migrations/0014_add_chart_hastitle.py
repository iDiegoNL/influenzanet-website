...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Chart.hastitle'
        db.add_column('pollster_chart', 'hastitle', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Chart.hastitle'
        db.delete_column('pollster_chart', 'hastitle')
