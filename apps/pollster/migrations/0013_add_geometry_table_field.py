...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Chart.geotable'
        db.add_column('pollster_chart', 'geotable', self.gf('django.db.models.fields.CharField')(default='pollster_zip_codes', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Chart.geotable'
        db.delete_column('pollster_chart', 'geotable')
