...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pollster_question', 'title', self.gf('django.db.models.fields.TextField')(max_length=4096))


    def backwards(self, orm):
        
        # Changing field 'Question.title'
        db.alter_column('pollster_question', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))
