...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TranslationQuestion.title'
        db.alter_column('pollster_translationquestion', 'title', self.gf('django.db.models.fields.CharField')(max_length=4096))


    def backwards(self, orm):
        
        # Changing field 'TranslationQuestion.title'
        db.alter_column('pollster_translationquestion', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'pollster.chart': {
            ...
            'hastitle': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'pollster.question': {
            ...
            'title': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '4096', 'blank': 'True'}),
        ...
        'pollster.translationquestion': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pollster.Question']"}),
            'title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4096', 'blank': 'True'}),
            'translation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pollster.TranslationSurvey']"})
        },
