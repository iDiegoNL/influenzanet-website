...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.tags'
        db.alter_column('pollster_question', 'tags', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Question.tags'
        db.alter_column('pollster_question', 'tags', self.gf('django.db.models.fields.CharField')(max_length=255))
