...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('survey_surveyuser', 'last_participation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Participation'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'survey.surveyuser': {
            ...
            'global_id': ('django.db.models.fields.CharField', [], {'default': "'0f9c73a4-5efc-4151-a4e2-8d7cf8633770'", 'unique': 'True', 'max_length': '36'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
